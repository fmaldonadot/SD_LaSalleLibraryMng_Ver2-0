========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet SD_LaSalleLibraryMng_Ver2-0
========================================================================

AppWizard a créé cette application SD_LaSalleLibraryMng_Ver2-0 pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application SD_LaSalleLibraryMng_Ver2-0.


SD_LaSalleLibraryMng_Ver2-0.vcxproj
...
SD_LaSalleLibraryMng_Ver2-0.vcxproj.filters
...
SD_LaSalleLibraryMng_Ver2-0.cpp
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) SD_LaSalleLibraryMng_Ver2-0.pch et un fichier de type précompilé nommé StdAfx.obj.
